...
These models are used internally by the TUI and converted from protobuf responses.
For daemon communication, use orch_monitor.proto_client.ProtoDaemonClient.
"""
