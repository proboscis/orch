...
class StartRunRequest(_message.Message):
    __slots__ = ("issues_root", "issue_id", "agent", "model", "model_variant", "base_branch", "project_root")
    ISSUES_ROOT_FIELD_NUMBER: _ClassVar[int]
    ISSUE_ID_FIELD_NUMBER: _ClassVar[int]
    AGENT_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
    ...
    base_branch: str
    project_root: str
    def __init__(self, issues_root: _Optional[str] = ..., issue_id: _Optional[str] = ..., agent: _Optional[str] = ..., model: _Optional[str] = ..., model_variant: _Optional[str] = ..., base_branch: _Optional[str] = ..., project_root: _Optional[str] = ...) -> None: ...
...
class GetGitContextRequest(_message.Message):
    __slots__ = ("work_dir",)
    WORK_DIR_FIELD_NUMBER: _ClassVar[int]
    work_dir: str
    def __init__(self, work_dir: _Optional[str] = ...) -> None: ...

class GetGitContextResponse(_message.Message):
    __slots__ = ("branch", "uncommitted_changes", "last_commit_message")
    BRANCH_FIELD_NUMBER: _ClassVar[int]
    UNCOMMITTED_CHANGES_FIELD_NUMBER: _ClassVar[int]
    LAST_COMMIT_MESSAGE_FIELD_NUMBER: _ClassVar[int]
    branch: str
    uncommitted_changes: str
    last_commit_message: str
    def __init__(self, branch: _Optional[str] = ..., uncommitted_changes: _Optional[str] = ..., last_commit_message: _Optional[str] = ...) -> None: ...
...
class Request(_message.Message):
    ...
    GET_GIT_CONTEXT_FIELD_NUMBER: _ClassVar[int]
    ping: PingRequest
