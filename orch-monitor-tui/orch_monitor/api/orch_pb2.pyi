...
class Run(_message.Message):
    ...
    AGENT_SESSION_GENERATION_FIELD_NUMBER: _ClassVar[int]
    SESSION_STATE_FIELD_NUMBER: _ClassVar[int]
    SESSION_STATE_DETAIL_FIELD_NUMBER: _ClassVar[int]
    issue_id: str
    run_id: str
    status: RunStatus
    agent: str
...
class StartRunRequest(_message.Message):
    __slots__ = ("issue_id", "agent", "model", "model_variant", "base_branch", "preset", "branch", "worktree_dir", "no_pr", "prompt_template", "pr_target_branch", "dry_run", "reuse", "run_id", "agent_cmd", "agent_profile", "multiplexer", "target", "context", "codex_profile", "no_session")
    ISSUE_ID_FIELD_NUMBER: _ClassVar[int]
    AGENT_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
...
class ContinueRunRequest(_message.Message):
    __slots__ = ("issue_id", "run_id", "short_id", "branch", "agent", "agent_cmd", "agent_profile", "worktree_dir", "no_pr", "prompt_template", "pr_target_branch", "multiplexer", "session_name", "codex_profile", "context", "no_session")
    ISSUE_ID_FIELD_NUMBER: _ClassVar[int]
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    SHORT_ID_FIELD_NUMBER: _ClassVar[int]
    BRANCH_FIELD_NUMBER: _ClassVar[int]
...
class GetConfigResponse(_message.Message):
    __slots__ = ("agent", "model", "model_variant", "worktree_dir", "base_branch", "pr_target_branch", "log_level", "prompt_template", "multiplexer", "agent_multiplexer", "no_pr", "default_preset", "control_agent", "control_model", "control_model_variant", "diff_tool", "presets", "opencode", "claude", "codex", "gemini", "slack", "issues", "github", "ps")
    AGENT_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
    MODEL_VARIANT_FIELD_NUMBER: _ClassVar[int]
    WORKTREE_DIR_FIELD_NUMBER: _ClassVar[int]
