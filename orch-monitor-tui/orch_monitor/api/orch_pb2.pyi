...
class PRStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PR_STATUS_NONE: _ClassVar[PRStatus]
...
class Run(_message.Message):
    __slots__ = ("issue_id", "run_id", "status", "agent", "model", "branch", "worktree_path", "pr_url", "started_at_unix", "updated_at_unix", "elapsed_seconds", "elapsed_display", "diff_stats", "branch_state", "tmux_session", "multiplexer", "server_port", "opencode_session_id", "continued_from", "pr_status")
