...
class WaitForStatusRequest(_message.Message):
    __slots__ = ("issue_id", "run_id", "short_id", "until", "timeout_seconds", "context")
    ISSUE_ID_FIELD_NUMBER: _ClassVar[int]
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    timeout_seconds: int
    context: RequestContext
    def __init__(self, issue_id: _Optional[str] = ..., run_id: _Optional[str] = ..., short_id: _Optional[str] = ..., until: _Optional[_Union[RunStatus, str]] = ..., timeout_seconds: _Optional[int] = ..., context: _Optional[_Union[RequestContext, _Mapping]] = ...) -> None: ...

class WaitForStatusResponse(_message.Message):
    __slots__ = ("run", "events")
    RUN_FIELD_NUMBER: _ClassVar[int]
    EVENTS_FIELD_NUMBER: _ClassVar[int]
    run: Run
...
class Request(_message.Message):
    ...
    WAIT_FOR_STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    wait_for_status: WaitForStatusRequest
...
class Response(_message.Message):
    ...
    wait_for_status: WaitForStatusResponse
