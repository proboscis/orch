...
func (c *DaemonClient) GetIssue(ctx context.Context, issueID model.IssueID) (*Issue, error) {
	resp, err := c.proto.GetIssue(issueID.String())
	if err != nil {
		if isNotFoundError(err) {
			return nil, IssueNotFound(issueID.String())
		}
		return nil, err
	}
...
func (c *DaemonClient) CreateIssue(ctx context.Context, req *CreateIssueRequest) (*Issue, error) {
	resp, err := c.proto.CreateIssue(req.ID.String(), req.Title, "", req.Body, req.Tags, req.BaseBranch)
	if err != nil {
		return nil, err
	}
	return &Issue{
		ID:         model.NewIssueID(resp.IssueID),
		Path:       resp.Path,
		Title:      req.Title,
		Body:       req.Body,
...
func (c *DaemonClient) SetIssueStatus(ctx context.Context, issueID model.IssueID, status IssueStatus) error {
	if status == IssueStatusClosed || status == IssueStatusResolved {
		_, err := c.proto.CloseIssue(issueID.String(), "")
		return err
	}
...
func (c *DaemonClient) ResolveRun(ctx context.Context, ref RunRef) (*Run, error) {
	if ref.ShortID != "" {
		resp, err := c.proto.GetRunByShortID(ref.ShortID.String())
		if err != nil {
			if isNotFoundError(err) {
				return nil, RunNotFound(ref.ShortID.String())
			}
			return nil, err
		}
	...
	if ref.RunID != "" {
		resp, err := c.proto.GetRun(ref.IssueID.String(), ref.RunID.String())
		if err != nil {
			if isNotFoundError(err) {
	...
	runs, err := c.proto.ListRuns(&daemon.ListRunsFilter{IssueID: ref.IssueID.String(), Limit: 1})
	if err != nil {
		return nil, err
	}
	if len(runs.Runs) == 0 {
		return nil, RunNotFound(ref.IssueID.String())
	}
...
func (c *DaemonClient) GetRun(ctx context.Context, issueID model.IssueID, runID model.RunID) (*Run, error) {
	resp, err := c.proto.GetRun(issueID.String(), runID.String())
	if err != nil {
		if isNotFoundError(err) {
			return nil, RunNotFound(issueID.String() + "#" + runID.String())
		}
		return nil, err
	}
	return runFromDaemonFull(resp.Run), nil
...
func (c *DaemonClient) GetLatestRun(ctx context.Context, issueID model.IssueID) (*Run, error) {
	runs, err := c.proto.ListRuns(&daemon.ListRunsFilter{IssueID: issueID.String(), Limit: 1})
	if err != nil {
		return nil, err
	}
	if len(runs.Runs) == 0 {
		return nil, RunNotFound(issueID.String())
	}
	resp, err := c.proto.GetRun(runs.Runs[0].IssueID, runs.Runs[0].RunID)
	if err != nil {
		return nil, err
...
func (c *DaemonClient) StartRun(ctx context.Context, req *StartRunRequest) (*StartRunResult, error) {
	...
	return &StartRunResult{
		RunID:        model.NewRunID(resp.RunID),
		Branch:       resp.Branch,
...
func (c *DaemonClient) StopRun(ctx context.Context, ref RunRef) error {
	...
	_, err = c.proto.StopRun(run.IssueID.String(), run.RunID.String(), false)
	return err
}
...
func (c *DaemonClient) AppendEvent(ctx context.Context, ref RunRef, event *Event) (*AppendEventResult, error) {
	...
	resp, err := c.proto.AppendEvent(run.IssueID.String(), run.RunID.String(), event.Type, event.Name, event.Attrs, "cli")
	if err != nil {
		return nil, err
	}
...
func (c *DaemonClient) WaitForRuns(ctx context.Context, refs []string, timeoutSeconds int) (*WaitForRunsResult, error) {
	...
	return &WaitForRunsResult{
		...
		IssueID: model.NewIssueID(resp.Issue),
		PRURL:   resp.PRURL,
	}, nil
}

func (c *DaemonClient) GetAttachInfo(ctx context.Context, ref RunRef) (*AttachInfo, error) {
	resp, err := c.proto.GetAttachInfo(ref.IssueID.String(), ref.RunID.String(), ref.ShortID.String())
	if err != nil {
		if isNotFoundError(err) {
			return nil, RunNotFound(ref.String())
		}
	...
	if !resp.OK {
		if resp.Error == "session_not_found" || resp.Error == "no sessions" {
			return &AttachInfo{
				IssueID:       model.NewIssueID(resp.IssueID),
				RunID:         model.NewRunID(resp.RunID),
				SessionName:   resp.SessionName,
...
func (c *DaemonClient) CaptureSession(ctx context.Context, ref RunRef, lines int) (*CaptureResult, error) {
	...
	resp, err := c.proto.CaptureSession(run.IssueID.String(), run.RunID.String(), lines)
	if err != nil {
		return nil, err
	}
...
func (c *DaemonClient) SendMessage(ctx context.Context, ref RunRef, message string, noEnter bool) error {
	...
	return c.proto.SendMessage(run.IssueID.String(), run.RunID.String(), message, noEnter)
}
...
func (c *DaemonClient) InjectInitialPrompt(ctx context.Context, ref RunRef, prompt string) error {
	...
	return c.proto.InjectInitialPrompt(run.IssueID.String(), run.RunID.String(), prompt)
}
...
func (c *DaemonClient) GetDiffStats(ctx context.Context, ref RunRef) (*DiffStats, error) {
	...
	resp, err := c.proto.GetDiffStats(run.IssueID.String(), run.RunID.String())
	if err != nil {
		return nil, err
	}
...
func (c *DaemonClient) GetBranchState(ctx context.Context, ref RunRef) (BranchState, error) {
	...
	state, err := c.proto.GetBranchState(run.IssueID.String(), run.RunID.String())
	if err != nil {
		return "", err
	}
...
func (c *DaemonClient) GetDiff(ctx context.Context, ref RunRef) (string, error) {
	...
	return c.proto.GetDiff(run.IssueID.String(), run.RunID.String())
}

func (c *DaemonClient) ResolveIssue(ctx context.Context, issueID model.IssueID, force bool) error {
	_, err := c.proto.ResolveIssue(issueID.String(), force)
	return err
}
...
func runFromDaemonFull(r *daemon.RunFull) *Run {
	...
	return &Run{
		IssueID:           model.NewIssueID(r.IssueID),
		RunID:             model.NewRunID(r.RunID),
		ShortID:           model.NewShortID(r.ShortID),
...
func (c *DaemonClient) DeleteRun(ctx context.Context, ref RunRef, opts *DeleteRunOptions) (*DeleteRunResult, error) {
	...
	resp, err := c.proto.DeleteRun(ref.IssueID.String(), ref.RunID.String(), ref.ShortID.String(), opts.WithWorktree, opts.WithBranch, opts.Force)
	if err != nil {
		return nil, err
	}
	return &DeleteRunResult{
		IssueID:         model.NewIssueID(resp.IssueID),
		RunID:           model.NewRunID(resp.RunID),
		ShortID:         model.NewShortID(resp.ShortID),
...
func (c *DaemonClient) CleanRunWorktree(ctx context.Context, ref RunRef) (*CleanRunWorktreeResult, error) {
	resp, err := c.proto.CleanRunWorktree(ref.IssueID.String(), ref.RunID.String(), ref.ShortID.String())
	if err != nil {
		return nil, err
	}
...
func (c *DaemonClient) UpdateIssue(ctx context.Context, issueID model.IssueID, req *UpdateIssueRequest) (*Issue, error) {
	resp, err := c.proto.UpdateIssue(issueID.String(), req.Title, req.Summary, req.Body, string(req.Status))
	if err != nil {
		return nil, err
	}
...
func (c *DaemonClient) ValidateIssueFiles(ctx context.Context, issueID model.IssueID) (*ValidateIssueFilesResult, error) {
	resp, err := c.proto.ValidateIssueFiles(issueID.String())
	if err != nil {
		return nil, err
	}
	...
	for _, e := range resp.Errors {
		vr := &ValidationResult{
			File:    e.File,
			IssueID: model.NewIssueID(e.IssueID),
		}
	...
	for _, w := range resp.Warnings {
		vr := &ValidationResult{
			File:    w.File,
			IssueID: model.NewIssueID(w.IssueID),
		}
...
func (c *DaemonClient) WriteAgentPrompt(ctx context.Context, ref RunRef, content string) error {
	return c.proto.WriteAgentPrompt(ref.IssueID.String(), ref.RunID.String(), ref.ShortID.String(), content)
}

func (c *DaemonClient) ReadAgentPrompt(ctx context.Context, ref RunRef) (string, error) {
	return c.proto.ReadAgentPrompt(ref.IssueID.String(), ref.RunID.String(), ref.ShortID.String())
}
...
func (c *DaemonClient) CreateRun(ctx context.Context, req *CreateRunRequest) (*CreateRunResult, error) {
	resp, err := c.proto.CreateRun(req.IssueID.String(), req.RunID.String(), req.Metadata)
	if err != nil {
		return nil, err
	}
