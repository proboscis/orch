...
const (
	PRStatus_PR_STATUS_UNSPECIFIED PRStatus = 0 // "-" / no PR
	PRStatus_PR_STATUS_OPEN        PRStatus = 1 // PR is open
	PRStatus_PR_STATUS_MERGED      PRStatus = 2 // PR is merged
	PRStatus_PR_STATUS_CLOSED      PRStatus = 3 // PR is closed
)
...
type Run struct {
	...
	PrStatus          PRStatus               `protobuf:"varint,22,opt,name=pr_status,json=prStatus,proto3,enum=orch.v1.PRStatus" json:"pr_status,omitempty"`
	IsActive          bool                   `protobuf:"varint,23,opt,name=is_active,json=isActive,proto3" json:"is_active,omitempty"`
	WorktreeExists    bool                   `protobuf:"varint,24,opt,name=worktree_exists,json=worktreeExists,proto3" json:"worktree_exists,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Run) GetPrStatus() PRStatus {
	if x != nil {
		return x.PrStatus
	}
...
const file_orch_proto_rawDesc = "" +
	...
	"\x05files\x18\x04 \x03(\tR\x05files\"\xf2\x06\n" +
	"\x03Run\x12\x19\n" +
	...
	"\tpr_status\x18\x16 \x01(\x0e2\x11.orch.v1.PRStatusR\bprStatus\x12\x1b\n" +
	"\tis_active\x18\x17 \x01(\bR\bisActive\x12'\n" +
	"\x0fworktree_exists\x18\x18 \x01(\bR\x0eworktreeExists\"\xf1\x01\n" +
	"\x05Issue\x12\x0e\n" +
	...
	"\x12MULTIPLEXER_ZELLIJ\x10\x02*e\n" +
	"\bPRStatus\x12\x19\n" +
	"\x15PR_STATUS_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0ePR_STATUS_OPEN\x10\x01\x12\x14\n" +
	"\x10PR_STATUS_MERGED\x10\x02\x12\x14\n" +
	"\x10PR_STATUS_CLOSED\x10\x03B#Z!github.com/s22625/orch/api/orchpbb\x06proto3"
...
var file_orch_proto_depIdxs = []int32{
	...
	4,   // 4: orch.v1.Run.pr_status:type_name -> orch.v1.PRStatus
	1,   // 5: orch.v1.Issue.status:type_name -> orch.v1.IssueStatus
	104, // 6: orch.v1.Event.attrs:type_name -> orch.v1.Event.AttrsEntry
	0,   // 7: orch.v1.ListRunsRequest.status:type_name -> orch.v1.RunStatus
	...
	7,   // 13: orch.v1.ListIssuesResponse.issues:type_name -> orch.v1.Issue
	7,   // 14: orch.v1.GetIssueResponse.issue:type_name -> orch.v1.Issue
	3,   // 15: orch.v1.GetAttachInfoResponse.multiplexer:type_name -> orch.v1.Multiplexer
	5,   // 16: orch.v1.GetDiffStatsResponse.diff_stats:type_name -> orch.v1.DiffStats
	2,   // 17: orch.v1.GetBranchStateResponse.state:type_name -> orch.v1.BranchState
	52,  // 18: orch.v1.ListMonitorsResponse.monitors:type_name -> orch.v1.MonitorInfo
	6,   // 19: orch.v1.GetRunByShortIDResponse.run:type_name -> orch.v1.Run
	8,   // 20: orch.v1.GetRunByShortIDResponse.events:type_name -> orch.v1.Event
	106, // 21: orch.v1.AppendEventRequest.event_attrs:type_name -> orch.v1.AppendEventRequest.EventAttrsEntry
	67,  // 22: orch.v1.ListReposResponse.repos:type_name -> orch.v1.RepoInfo
	7,   // 23: orch.v1.UpdateIssueResponse.issue:type_name -> orch.v1.Issue
	74,  // 24: orch.v1.ValidationResultItem.errors:type_name -> orch.v1.ValidationIssue
	74,  // 25: orch.v1.ValidationResultItem.warnings:type_name -> orch.v1.ValidationIssue
	75,  // 26: orch.v1.ValidateIssueFilesResponse.errors:type_name -> orch.v1.ValidationResultItem
	75,  // 27: orch.v1.ValidateIssueFilesResponse.warnings:type_name -> orch.v1.ValidationResultItem
	76,  // 28: orch.v1.ValidateIssueFilesResponse.duplicates:type_name -> orch.v1.DuplicateIDItem
	3,   // 29: orch.v1.KillSessionRequest.multiplexer:type_name -> orch.v1.Multiplexer
	3,   // 30: orch.v1.ListSessionsRequest.multiplexer:type_name -> orch.v1.Multiplexer
	98,  // 31: orch.v1.OpenCodeProviderInfo.models:type_name -> orch.v1.OpenCodeModelInfo
	97,  // 32: orch.v1.QueryOpenCodeServerResponse.providers:type_name -> orch.v1.OpenCodeProviderInfo
	107, // 33: orch.v1.QueryOpenCodeServerResponse.session_status:type_name -> orch.v1.QueryOpenCodeServerResponse.SessionStatusEntry
	9,   // 34: orch.v1.Request.ping:type_name -> orch.v1.PingRequest
	11,  // 35: orch.v1.Request.list_runs:type_name -> orch.v1.ListRunsRequest
	13,  // 36: orch.v1.Request.get_run:type_name -> orch.v1.GetRunRequest
	15,  // 37: orch.v1.Request.start_run:type_name -> orch.v1.StartRunRequest
	19,  // 38: orch.v1.Request.stop_run:type_name -> orch.v1.StopRunRequest
	21,  // 39: orch.v1.Request.resolve_run:type_name -> orch.v1.ResolveRunRequest
	23,  // 40: orch.v1.Request.list_issues:type_name -> orch.v1.ListIssuesRequest
	25,  // 41: orch.v1.Request.get_issue:type_name -> orch.v1.GetIssueRequest
	27,  // 42: orch.v1.Request.create_issue:type_name -> orch.v1.CreateIssueRequest
	29,  // 43: orch.v1.Request.close_issue:type_name -> orch.v1.CloseIssueRequest
	31,  // 44: orch.v1.Request.get_control_agent_launch:type_name -> orch.v1.GetControlAgentLaunchRequest
	33,  // 45: orch.v1.Request.get_attach_info:type_name -> orch.v1.GetAttachInfoRequest
	35,  // 46: orch.v1.Request.capture_session:type_name -> orch.v1.CaptureSessionRequest
	37,  // 47: orch.v1.Request.send_message:type_name -> orch.v1.SendMessageRequest
	39,  // 48: orch.v1.Request.get_diff_stats:type_name -> orch.v1.GetDiffStatsRequest
	41,  // 49: orch.v1.Request.get_branch_state:type_name -> orch.v1.GetBranchStateRequest
	43,  // 50: orch.v1.Request.get_diff:type_name -> orch.v1.GetDiffRequest
	45,  // 51: orch.v1.Request.register_monitor:type_name -> orch.v1.RegisterMonitorRequest
	47,  // 52: orch.v1.Request.unregister_monitor:type_name -> orch.v1.UnregisterMonitorRequest
	49,  // 53: orch.v1.Request.heartbeat:type_name -> orch.v1.HeartbeatRequest
	51,  // 54: orch.v1.Request.list_monitors:type_name -> orch.v1.ListMonitorsRequest
	54,  // 55: orch.v1.Request.kill_monitor:type_name -> orch.v1.KillMonitorRequest
	56,  // 56: orch.v1.Request.get_run_by_short_id:type_name -> orch.v1.GetRunByShortIDRequest
	58,  // 57: orch.v1.Request.resolve_issue:type_name -> orch.v1.ResolveIssueRequest
	60,  // 58: orch.v1.Request.append_event:type_name -> orch.v1.AppendEventRequest
	62,  // 59: orch.v1.Request.ensure_opencode_server:type_name -> orch.v1.EnsureOpenCodeServerRequest
	64,  // 60: orch.v1.Request.register_repo:type_name -> orch.v1.RegisterRepoRequest
	66,  // 61: orch.v1.Request.list_repos:type_name -> orch.v1.ListReposRequest
	69,  // 62: orch.v1.Request.delete_run:type_name -> orch.v1.DeleteRunRequest
	71,  // 63: orch.v1.Request.update_issue:type_name -> orch.v1.UpdateIssueRequest
	73,  // 64: orch.v1.Request.validate_issue_files:type_name -> orch.v1.ValidateIssueFilesRequest
	78,  // 65: orch.v1.Request.write_agent_prompt:type_name -> orch.v1.WriteAgentPromptRequest
	80,  // 66: orch.v1.Request.read_agent_prompt:type_name -> orch.v1.ReadAgentPromptRequest
	82,  // 67: orch.v1.Request.repair_state:type_name -> orch.v1.RepairStateRequest
	84,  // 68: orch.v1.Request.get_daemon_log:type_name -> orch.v1.GetDaemonLogRequest
	86,  // 69: orch.v1.Request.read_file:type_name -> orch.v1.ReadFileRequest
	88,  // 70: orch.v1.Request.write_file:type_name -> orch.v1.WriteFileRequest
	17,  // 71: orch.v1.Request.create_run:type_name -> orch.v1.CreateRunRequest
	90,  // 72: orch.v1.Request.kill_session:type_name -> orch.v1.KillSessionRequest
	92,  // 73: orch.v1.Request.list_sessions:type_name -> orch.v1.ListSessionsRequest
	94,  // 74: orch.v1.Request.resume_run:type_name -> orch.v1.ResumeRunRequest
	96,  // 75: orch.v1.Request.query_opencode_server:type_name -> orch.v1.QueryOpenCodeServerRequest
	100, // 76: orch.v1.Request.inject_initial_prompt:type_name -> orch.v1.InjectInitialPromptRequest
	10,  // 77: orch.v1.Response.ping:type_name -> orch.v1.PingResponse
	12,  // 78: orch.v1.Response.list_runs:type_name -> orch.v1.ListRunsResponse
	14,  // 79: orch.v1.Response.get_run:type_name -> orch.v1.GetRunResponse
	16,  // 80: orch.v1.Response.start_run:type_name -> orch.v1.StartRunResponse
	20,  // 81: orch.v1.Response.stop_run:type_name -> orch.v1.StopRunResponse
	22,  // 82: orch.v1.Response.resolve_run:type_name -> orch.v1.ResolveRunResponse
	24,  // 83: orch.v1.Response.list_issues:type_name -> orch.v1.ListIssuesResponse
	26,  // 84: orch.v1.Response.get_issue:type_name -> orch.v1.GetIssueResponse
	28,  // 85: orch.v1.Response.create_issue:type_name -> orch.v1.CreateIssueResponse
	30,  // 86: orch.v1.Response.close_issue:type_name -> orch.v1.CloseIssueResponse
	32,  // 87: orch.v1.Response.get_control_agent_launch:type_name -> orch.v1.GetControlAgentLaunchResponse
	34,  // 88: orch.v1.Response.get_attach_info:type_name -> orch.v1.GetAttachInfoResponse
	36,  // 89: orch.v1.Response.capture_session:type_name -> orch.v1.CaptureSessionResponse
	38,  // 90: orch.v1.Response.send_message:type_name -> orch.v1.SendMessageResponse
	40,  // 91: orch.v1.Response.get_diff_stats:type_name -> orch.v1.GetDiffStatsResponse
	42,  // 92: orch.v1.Response.get_branch_state:type_name -> orch.v1.GetBranchStateResponse
	44,  // 93: orch.v1.Response.get_diff:type_name -> orch.v1.GetDiffResponse
	46,  // 94: orch.v1.Response.register_monitor:type_name -> orch.v1.RegisterMonitorResponse
	48,  // 95: orch.v1.Response.unregister_monitor:type_name -> orch.v1.UnregisterMonitorResponse
	50,  // 96: orch.v1.Response.heartbeat:type_name -> orch.v1.HeartbeatResponse
	53,  // 97: orch.v1.Response.list_monitors:type_name -> orch.v1.ListMonitorsResponse
	55,  // 98: orch.v1.Response.kill_monitor:type_name -> orch.v1.KillMonitorResponse
	57,  // 99: orch.v1.Response.get_run_by_short_id:type_name -> orch.v1.GetRunByShortIDResponse
	59,  // 100: orch.v1.Response.resolve_issue:type_name -> orch.v1.ResolveIssueResponse
	61,  // 101: orch.v1.Response.append_event:type_name -> orch.v1.AppendEventResponse
	63,  // 102: orch.v1.Response.ensure_opencode_server:type_name -> orch.v1.EnsureOpenCodeServerResponse
	65,  // 103: orch.v1.Response.register_repo:type_name -> orch.v1.RegisterRepoResponse
	68,  // 104: orch.v1.Response.list_repos:type_name -> orch.v1.ListReposResponse
	70,  // 105: orch.v1.Response.delete_run:type_name -> orch.v1.DeleteRunResponse
	72,  // 106: orch.v1.Response.update_issue:type_name -> orch.v1.UpdateIssueResponse
	77,  // 107: orch.v1.Response.validate_issue_files:type_name -> orch.v1.ValidateIssueFilesResponse
	79,  // 108: orch.v1.Response.write_agent_prompt:type_name -> orch.v1.WriteAgentPromptResponse
	81,  // 109: orch.v1.Response.read_agent_prompt:type_name -> orch.v1.ReadAgentPromptResponse
	83,  // 110: orch.v1.Response.repair_state:type_name -> orch.v1.RepairStateResponse
	85,  // 111: orch.v1.Response.get_daemon_log:type_name -> orch.v1.GetDaemonLogResponse
	87,  // 112: orch.v1.Response.read_file:type_name -> orch.v1.ReadFileResponse
	89,  // 113: orch.v1.Response.write_file:type_name -> orch.v1.WriteFileResponse
	18,  // 114: orch.v1.Response.create_run:type_name -> orch.v1.CreateRunResponse
	91,  // 115: orch.v1.Response.kill_session:type_name -> orch.v1.KillSessionResponse
	93,  // 116: orch.v1.Response.list_sessions:type_name -> orch.v1.ListSessionsResponse
	95,  // 117: orch.v1.Response.resume_run:type_name -> orch.v1.ResumeRunResponse
	99,  // 118: orch.v1.Response.query_opencode_server:type_name -> orch.v1.QueryOpenCodeServerResponse
	101, // 119: orch.v1.Response.inject_initial_prompt:type_name -> orch.v1.InjectInitialPromptResponse
