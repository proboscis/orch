...
type GetGitContextRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetGitContextRequest) Reset() {
	*x = GetGitContextRequest{}
	mi := &file_orch_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetGitContextRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGitContextRequest) ProtoMessage() {}

func (x *GetGitContextRequest) ProtoReflect() protoreflect.Message {
	mi := &file_orch_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGitContextRequest.ProtoReflect.Descriptor instead.
func (*GetGitContextRequest) Descriptor() ([]byte, []int) {
	return file_orch_proto_rawDescGZIP(), []int{40}
}

func (x *GetGitContextRequest) GetWorkDir() string {
	if x != nil {
		return x.WorkDir
	}
	return ""
...
type GetGitContextResponse struct {
	...
	UncommittedChanges string                 `protobuf:"bytes,2,opt,name=uncommitted_changes,json=uncommittedChanges,proto3" json:"uncommitted_changes,omitempty"` // "Yes", "No", or "Unknown"
	LastCommitMessage  string                 `protobuf:"bytes,3,opt,name=last_commit_message,json=lastCommitMessage,proto3" json:"last_commit_message,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *GetGitContextResponse) Reset() {
	*x = GetGitContextResponse{}
	mi := &file_orch_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetGitContextResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGitContextResponse) ProtoMessage() {}

func (x *GetGitContextResponse) ProtoReflect() protoreflect.Message {
	mi := &file_orch_proto_msgTypes[41]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGitContextResponse.ProtoReflect.Descriptor instead.
func (*GetGitContextResponse) Descriptor() ([]byte, []int) {
	return file_orch_proto_rawDescGZIP(), []int{41}
}

func (x *GetGitContextResponse) GetBranch() string {
	if x != nil {
		return x.Branch
	}
	return ""
...
func (x *GetGitContextResponse) GetUncommittedChanges() string {
	if x != nil {
...
func (x *GetGitContextResponse) GetLastCommitMessage() string {
	if x != nil {
...
func (x *Request) GetGetGitContext() *GetGitContextRequest {
	if x != nil {
		if x, ok := x.Request.(*Request_GetGitContext); ok {
			return x.GetGitContext
		}
	}
	return nil
}
...
type Request_GetGitContext struct {
	GetGitContext *GetGitContextRequest `protobuf:"bytes,39,opt,name=get_git_context,json=getGitContext,proto3,oneof"`
}
...
func (*Request_GetGitContext) isRequest_Request() {}
...
func (x *Response) GetGetGitContext() *GetGitContextResponse {
	if x != nil {
		if x, ok := x.Response.(*Response_GetGitContext); ok {
			return x.GetGitContext
		}
	}
	return nil
...
type Response_GetGitContext struct {
	GetGitContext *GetGitContextResponse `protobuf:"bytes,41,opt,name=get_git_context,json=getGitContext,proto3,oneof"`
}
...
func (*Response_GetGitContext) isResponse_Response() {}
...
const file_orch_proto_rawDesc = "" +
	...
	"\x04diff\x18\x01 \x01(\tR\x04diff\"1\n" +
	"\x14GetGitContextRequest\x12\x19\n" +
	"\bwork_dir\x18\x01 \x01(\tR\aworkDir\"\x90\x01\n" +
	"\x15GetGitContextResponse\x12\x16\n" +
	"\x06branch\x18\x01 \x01(\tR\x06branch\x12/\n" +
	"\x13uncommitted_changes\x18\x02 \x01(\tR\x12uncommittedChanges\x12.\n" +
	"\x13last_commit_message\x18\x03 \x01(\tR\x11lastCommitMessage\"\x9e\x01\n" +
	...
	"\n" +
	"create_run\x18& \x01(\v2\x19.orch.v1.CreateRunRequestH\x00R\tcreateRun\x12G\n" +
	"\x0fget_git_context\x18' \x01(\v2\x1d.orch.v1.GetGitContextRequestH\x00R\rgetGitContextB\t\n" +
	"\arequest\"\xb6\x15\n" +
	"\bResponse\x12\x0e\n" +
	...
	"\n" +
	"create_run\x18( \x01(\v2\x1a.orch.v1.CreateRunResponseH\x00R\tcreateRun\x12H\n" +
	"\x0fget_git_context\x18) \x01(\v2\x1e.orch.v1.GetGitContextResponseH\x00R\rgetGitContextB\n" +
	"\n" +
	"\bresponse*\xff\x01\n" +
	"\tRunStatus\x12\x1a\n" +
...
var file_orch_proto_msgTypes = make([]protoimpl.MessageInfo, 92)
var file_orch_proto_goTypes = []any{
	...
	(*GetGitContextRequest)(nil),          // 44: orch.v1.GetGitContextRequest
	(*GetGitContextResponse)(nil),         // 45: orch.v1.GetGitContextResponse
	...
	(*Request)(nil),                       // 91: orch.v1.Request
	(*Response)(nil),                      // 92: orch.v1.Response
	nil,                                   // 93: orch.v1.Event.AttrsEntry
	nil,                                   // 94: orch.v1.CreateRunRequest.MetadataEntry
	nil,                                   // 95: orch.v1.AppendEventRequest.EventAttrsEntry
}
var file_orch_proto_depIdxs = []int32{
	...
	93,  // 5: orch.v1.Event.attrs:type_name -> orch.v1.Event.AttrsEntry
	...
	94,  // 10: orch.v1.CreateRunRequest.metadata:type_name -> orch.v1.CreateRunRequest.MetadataEntry
	...
	95,  // 20: orch.v1.AppendEventRequest.event_attrs:type_name -> orch.v1.AppendEventRequest.EventAttrsEntry
	...
	46,  // 45: orch.v1.Request.register_monitor:type_name -> orch.v1.RegisterMonitorRequest
	48,  // 46: orch.v1.Request.unregister_monitor:type_name -> orch.v1.UnregisterMonitorRequest
	50,  // 47: orch.v1.Request.heartbeat:type_name -> orch.v1.HeartbeatRequest
	52,  // 48: orch.v1.Request.list_monitors:type_name -> orch.v1.ListMonitorsRequest
	55,  // 49: orch.v1.Request.kill_monitor:type_name -> orch.v1.KillMonitorRequest
	57,  // 50: orch.v1.Request.get_run_by_short_id:type_name -> orch.v1.GetRunByShortIDRequest
	59,  // 51: orch.v1.Request.resolve_issue:type_name -> orch.v1.ResolveIssueRequest
	61,  // 52: orch.v1.Request.append_event:type_name -> orch.v1.AppendEventRequest
	63,  // 53: orch.v1.Request.ensure_opencode_server:type_name -> orch.v1.EnsureOpenCodeServerRequest
	65,  // 54: orch.v1.Request.register_repo:type_name -> orch.v1.RegisterRepoRequest
	67,  // 55: orch.v1.Request.list_repos:type_name -> orch.v1.ListReposRequest
	70,  // 56: orch.v1.Request.delete_run:type_name -> orch.v1.DeleteRunRequest
	72,  // 57: orch.v1.Request.update_issue:type_name -> orch.v1.UpdateIssueRequest
	74,  // 58: orch.v1.Request.validate_issue_files:type_name -> orch.v1.ValidateIssueFilesRequest
	79,  // 59: orch.v1.Request.write_agent_prompt:type_name -> orch.v1.WriteAgentPromptRequest
	81,  // 60: orch.v1.Request.read_agent_prompt:type_name -> orch.v1.ReadAgentPromptRequest
	83,  // 61: orch.v1.Request.repair_state:type_name -> orch.v1.RepairStateRequest
	85,  // 62: orch.v1.Request.get_daemon_log:type_name -> orch.v1.GetDaemonLogRequest
	87,  // 63: orch.v1.Request.read_file:type_name -> orch.v1.ReadFileRequest
	89,  // 64: orch.v1.Request.write_file:type_name -> orch.v1.WriteFileRequest
	16,  // 65: orch.v1.Request.create_run:type_name -> orch.v1.CreateRunRequest
	44,  // 66: orch.v1.Request.get_git_context:type_name -> orch.v1.GetGitContextRequest
	9,   // 67: orch.v1.Response.ping:type_name -> orch.v1.PingResponse
	11,  // 68: orch.v1.Response.list_runs:type_name -> orch.v1.ListRunsResponse
	13,  // 69: orch.v1.Response.get_run:type_name -> orch.v1.GetRunResponse
	15,  // 70: orch.v1.Response.start_run:type_name -> orch.v1.StartRunResponse
	19,  // 71: orch.v1.Response.stop_run:type_name -> orch.v1.StopRunResponse
	21,  // 72: orch.v1.Response.resolve_run:type_name -> orch.v1.ResolveRunResponse
	23,  // 73: orch.v1.Response.list_issues:type_name -> orch.v1.ListIssuesResponse
	25,  // 74: orch.v1.Response.get_issue:type_name -> orch.v1.GetIssueResponse
	27,  // 75: orch.v1.Response.create_issue:type_name -> orch.v1.CreateIssueResponse
	29,  // 76: orch.v1.Response.close_issue:type_name -> orch.v1.CloseIssueResponse
	31,  // 77: orch.v1.Response.get_control_agent_launch:type_name -> orch.v1.GetControlAgentLaunchResponse
	33,  // 78: orch.v1.Response.get_attach_info:type_name -> orch.v1.GetAttachInfoResponse
	35,  // 79: orch.v1.Response.capture_session:type_name -> orch.v1.CaptureSessionResponse
	37,  // 80: orch.v1.Response.send_message:type_name -> orch.v1.SendMessageResponse
	39,  // 81: orch.v1.Response.get_diff_stats:type_name -> orch.v1.GetDiffStatsResponse
	41,  // 82: orch.v1.Response.get_branch_state:type_name -> orch.v1.GetBranchStateResponse
	43,  // 83: orch.v1.Response.get_diff:type_name -> orch.v1.GetDiffResponse
	47,  // 84: orch.v1.Response.register_monitor:type_name -> orch.v1.RegisterMonitorResponse
	49,  // 85: orch.v1.Response.unregister_monitor:type_name -> orch.v1.UnregisterMonitorResponse
	51,  // 86: orch.v1.Response.heartbeat:type_name -> orch.v1.HeartbeatResponse
	54,  // 87: orch.v1.Response.list_monitors:type_name -> orch.v1.ListMonitorsResponse
	56,  // 88: orch.v1.Response.kill_monitor:type_name -> orch.v1.KillMonitorResponse
	58,  // 89: orch.v1.Response.get_run_by_short_id:type_name -> orch.v1.GetRunByShortIDResponse
	60,  // 90: orch.v1.Response.resolve_issue:type_name -> orch.v1.ResolveIssueResponse
	62,  // 91: orch.v1.Response.append_event:type_name -> orch.v1.AppendEventResponse
	64,  // 92: orch.v1.Response.ensure_opencode_server:type_name -> orch.v1.EnsureOpenCodeServerResponse
	66,  // 93: orch.v1.Response.register_repo:type_name -> orch.v1.RegisterRepoResponse
	69,  // 94: orch.v1.Response.list_repos:type_name -> orch.v1.ListReposResponse
	71,  // 95: orch.v1.Response.delete_run:type_name -> orch.v1.DeleteRunResponse
	73,  // 96: orch.v1.Response.update_issue:type_name -> orch.v1.UpdateIssueResponse
	78,  // 97: orch.v1.Response.validate_issue_files:type_name -> orch.v1.ValidateIssueFilesResponse
	80,  // 98: orch.v1.Response.write_agent_prompt:type_name -> orch.v1.WriteAgentPromptResponse
	82,  // 99: orch.v1.Response.read_agent_prompt:type_name -> orch.v1.ReadAgentPromptResponse
	84,  // 100: orch.v1.Response.repair_state:type_name -> orch.v1.RepairStateResponse
	86,  // 101: orch.v1.Response.get_daemon_log:type_name -> orch.v1.GetDaemonLogResponse
	88,  // 102: orch.v1.Response.read_file:type_name -> orch.v1.ReadFileResponse
	90,  // 103: orch.v1.Response.write_file:type_name -> orch.v1.WriteFileResponse
	17,  // 104: orch.v1.Response.create_run:type_name -> orch.v1.CreateRunResponse
	45,  // 105: orch.v1.Response.get_git_context:type_name -> orch.v1.GetGitContextResponse
...
func file_orch_proto_init() {
	...
	file_orch_proto_msgTypes[87].OneofWrappers = []any{
		(*Request_Ping)(nil),
		...
		(*Request_GetGitContext)(nil),
	}
	file_orch_proto_msgTypes[88].OneofWrappers = []any{
		(*Response_Ping)(nil),
