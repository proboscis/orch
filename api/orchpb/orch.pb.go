...
const (
	...
	RunStatus_RUN_STATUS_UNKNOWN      RunStatus = 10
)
...
type StartRunRequest struct {
	...
	// no_session skips multiplexer session creation and prompt injection: the
	// run record, worktree, and branch are prepared but no agent is launched
	// (CLI --tmux=false).
	NoSession     bool `protobuf:"varint,23,opt,name=no_session,json=noSession,proto3" json:"no_session,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StartRunRequest) GetNoSession() bool {
	if x != nil {
		return x.NoSession
	}
	return false
...
func (x *ContinueRunRequest) GetNoSession() bool {
	if x != nil {
		return x.NoSession
	}
	return false
...
const file_orch_proto_rawDesc = "" +
	...
	"\x06events\x18\x02 \x03(\v2\x0e.orch.v1.EventR\x06events\"\x92\x05\n" +
	...
	"\x04port\x18\x02 \x01(\x05R\x04port\"\x98\x04\n" +
	...
	"\acontext\x18\x11 \x01(\v2\x17.orch.v1.RequestContextR\acontext\x12\x1d\n" +
	"\n" +
	"no_session\x18\x12 \x01(\bR\tnoSession\"\xe6\x01\n" +
